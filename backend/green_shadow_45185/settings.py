"""
Django settings for green_shadow_45185 project.
...
ROOT_URLCONF = 'green_shadow_45185.urls'
...
WSGI_APPLICATION = 'green_shadow_45185.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_shadow_45185 API",
    "DESCRIPTION": "API documentation for green_shadow_45185 App",
    "VERSION": "v1",
}
